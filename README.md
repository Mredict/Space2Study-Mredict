...
local	Local infrastructure	Vagrant + Ansible provisioning three VMs (with and without Docker), manual IaC, container hardening
cloud	Cloud infrastructure	Terraform-provisioned AWS resources, ECR, Jenkins-driven deployment
k8s	Kubernetes / GitOps	Self-managed k3s on EC2, Helm, ArgoCD, Kyverno policy enforcement, External Secrets Operator
...
For the full annotated file tree, see DEVSECOPS_FILE_TREE.md.
